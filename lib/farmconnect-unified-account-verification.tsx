    ...
    try {
      ...
      setVerificationNote(selected.source === "customer" && decision === "rejected"
        ...
        : selected.source === "customer"
          ? `${selected.name} approved. Customer KYC is now locked and the item left the queue.`
