-- FarmConnect caretaker application review fix
-- Run after 010_auth_role_guardian_caretaker_applications.sql.
-- Purpose: make admin approval idempotent and easier to diagnose.
...
select
  'caretaker_review_fix_ready' as check_name,
  count(*) as count
from information_schema.routines
where routine_schema = 'public'
  and routine_name = 'admin_review_caretaker_application';
