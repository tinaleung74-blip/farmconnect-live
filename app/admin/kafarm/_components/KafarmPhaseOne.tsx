...
const sqlAuditModules: SqlAuditModule[] = [
  ...
  { module: "Customer KYC", pages: "customer signup, /customer-v2/settings, /admin/account-verification", tables: ["customer_kyc_profiles"], functions: ["customer_submit_kyc", "run_kyc_system_checks", "admin_review_customer_kyc", "customer_record_kyc_consent"], views: [], policies: ["kyc"] },
  ...
  { module: "Add Rooster / Ownership", pages: "/customer-v2/add-rooster, /customer-v2/payment, /admin/customer-requests/payment", tables: ["farm_products", "farm_cart_items", "manual_payment_requests", "customer_animals"], functions: ["customer_submit_manual_payment_guarded", "admin_review_manual_payment_guarded"], views: [], policies: ["rooster ownership"] },
  { module: "Rooster Diary", pages: "/customer-v2/roosters, /customer-v2/roosters/diary", tables: ["animals", "customer_animals", "animal_photos", "animal_weights", "farm_care_requests", "caretaker_tasks", "task_proofs"], functions: ["customer_get_rooster_diary"], views: [], policies: ["customer animals"] },
  { module: "Care Payment / Assignment / Daily Report", pages: "/customer-v2/roosters/diary, /admin/customer-requests/payment, /admin/customer-requests/task, /caretaker/tasks", tables: ["manual_payment_requests", "farm_care_requests", "rooster_care_plans", "caretaker_tasks", "task_proofs"], functions: ["admin_assign_care_request", "caretaker_submit_daily_care_report", "admin_review_task_proof"], views: [], policies: ["care task"] },
  { module: "Caretaker Registration", pages: "/caretaker/signup, /admin/account-verification", tables: ["caretaker_applications", "caretakers"], functions: ["submit_caretaker_application", "admin_review_caretaker_application"], views: [], policies: ["caretaker"] },
