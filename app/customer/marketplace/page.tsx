      ...
      <div className="mx-auto max-w-7xl">
        <section className="grid gap-5 xl:grid-cols-[1.15fr_.85fr]">
          <div className="rounded-[42px] border border-white/15 bg-white/10 p-6 text-white shadow-2xl backdrop-blur-xl md:p-8">
            <p className="w-fit rounded-full bg-amber-300 px-4 py-2 text-sm font-black text-emerald-950">FarmConnect Marketplace</p>
            <h1 className="mt-5 text-4xl font-black leading-tight md:text-6xl">Farm essentials, ready to buy.</h1>
